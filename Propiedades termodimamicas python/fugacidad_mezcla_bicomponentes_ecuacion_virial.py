...
class fugacidad():
    ...
    def variables(self):
        ...
        self.y1=0.5#float(input("ingrese la fraccion de vapor de la sustancia 1 : "))
        self.y2=1-self.y1
        self.Tc11=535.5#float(input("ingrese la temperatura critica de la sustancia 1 (K) : "))
        self.Tc22=591.8#float(input("ingrese la temperatura critica de la sustancia 2 (K) : "))
        self.Pc11=41.50#float(input("ingrese la presion critica de la sustancia 1 (bar) : "))
        self.Pc22=41.06#float(input("ingrese la presion critica de la sustancia 2 (bar) : "))
        self.Vc11=267e-6#float(input("ingrese el volumen critico de la sustancia 1 (m3/Kmol) : "))
        self.Vc22=316e-6#float(input("ingrese el volumen critico de la sustancia 2 (m3/Kmol) : "))
        self.Zc11=0.249#float(input("ingrese el factor de compresibilidad critico para la sustancia 1 : "))
        self.Zc22=0.264#float(input("ingrese el factor de compresibilidad critico para la sustancia 2 : "))
        self.Zc12=((self.Zc11+self.Zc22)/(2))
        self.Vc12=(((self.Vc11**(1/3))+(self.Vc22**(1/3)))/2)**3
        self.Tc12=(self.Tc11*self.Tc22)**0.5
        self.w11=0.323#float(input("ingrese el factor acentrico de la sustancia 1"))
        self.w22=0.262#float(input("ingrese el factor acentrico de la sustancia 2"))
        self.w12=((self.w11+self.w22)/(2))
#        self.V11=float(input("ingrese el volumen molar de la sustancia 1"))
#        self.V22=float(input("ingrese el volumen molar de la sustancia 2"))
